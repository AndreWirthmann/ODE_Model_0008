...
for n = 1:size(Result,2)
    ...
    for Stage = 1:NumberOfStages
        ...
        MV = ResultCell{n,Stage,1};
        P = ResultCell{n,Stage,2};
        ...
        ResultCell{n,Stage,3} = DV;
        
        ResultCell2{n,1} = [ResultCell2{n,1}; MV];
        ResultCell2{n,2} = [ResultCell2{n,2}; P];
        ResultCell2{n,3} = [ResultCell2{n,3}; DV];
